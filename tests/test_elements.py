...
def test_table_data_search(page: Page, home_page: HomePageClass, table_data_search: TableDataSearchPageClass, SEARCHTERM) -> None:
...
@pytest.mark.parametrize('COLUMN, FILTER_TERM', 
                    [ 
                      ( 'user id', '4'),    
                      ( 'task', 'Bootstrap 3' ),
                      ( 'name', 'Holden Charles' ),
...
def test_table_filter_search(page: Page, home_page: HomePageClass, table_data_search: TableDataSearchPageClass, COLUMN, FILTER_TERM: str) -> None:
    home_page.selectTableDemo('Table Data Search')
    table_data_search.filterTable(COLUMN, FILTER_TERM)
    assert table_data_search.verifyFilter(COLUMN, FILTER_TERM)
